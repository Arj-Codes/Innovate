  ...
  return (
    <div className="h-[100vh] contact_wrapper w-full flex items-center justify-center">
      <div className="bg-white w-[90%] h-[80%] rounded-[50px] flex  flex-col items-center justify-center">
        ...
        <div className="w-[90%] h-[90%] bg-gray-200 rounded-[50px] flex sm:flex-row flex-col sm:justify-between sm:items-end relative">
          <img
            src="./contact.jpeg"
            alt="contact_img"
            className="sm:h-[100%] h-[30%] object-cover rounded-lg"
          />

          <form
            action="#"
            className="w-full h-full pl-2 flex flex-col justify-center px-[30px]"
          >
            <div className="mb-3">
              <h2
                for="email"
                class="block mb-2 text-lg font-bold text-gray-800 dark:text-gray-800 sm:text-left text-center"
              >
                Email
              </h2>
              <input
